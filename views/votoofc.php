    ...
    <body>
        <div class="container">
            ...
            <div class="row p">
                       ...
                       <div class="row">
                           <div class="col-md-12 col-sm-6 photoCont">
                                <div class="col-md-12 col-sm-6">
                                    <div class="imgCont">
                                        <img src="../images/ofc1.png" id="p1" class="imgCandidatos" >
                          ...
                          <div class="col-md-12 col-sm-6 photoCont">
                              <div class="col-md-12 col-sm-6">
                                  <div class="imgCont" style="background-color: blue">
                                      <img src="../images/ofc2.png" id="p2" class="imgCandidatos" >
                  ...
                  <div class="col-md-12">
                      <br>
                      <button class="btn btn-success center-block">Registrar Voto</button>
                  </div>
            </div>
        </div>
